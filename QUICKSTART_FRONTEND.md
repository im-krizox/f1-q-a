...
# f1-qa-frontend     Up 1 minute   0.0.0.0:80->80/tcp
```
...
3. Verificar que el puerto 80 no está ocupado:
   ```bash
   # Linux/Mac
   lsof -i :80
...
### Puerto 80 ocupado (Mac/Linux)

Si el puerto 80 está ocupado, modifica `docker-compose.yml`:
